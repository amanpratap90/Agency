...
const PlaceOrderContent = () => {
    ...
    // Parse params
    const serviceTitle = searchParams.get('serviceTitle') || 'General Service';
    const subServiceParam = searchParams.get('subService');
    const subService = subServiceParam ? JSON.parse(subServiceParam) : { title: 'Custom Package', price: 0 };
    ...
    return (
        <div className="min-h-screen bg-neutral-950 text-white pt-24 pb-12 px-4">
            <div className="max-w-2xl mx-auto">
                <button onClick={() => router.back()} className="flex items-center gap-2 text-neutral-400 hover:text-white mb-8 transition-colors">
